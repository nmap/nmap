...
static void printusage() {
  ...
  printf("%s %s ( %s )\n"
         ...
         "  --max-os-tries <tries>: Set the maximum number of OS detection tries against a target\n"
         ...
         "  --defeat-rst-ratelimit: Ignore rate limits\n"
         "  --nsock-engine <engine>: Enforce use of a given nsock IO multiplexing engine.\n"
         "  --nogcc: Turn off group congestion control\n"
         ...
         "  --servicedb <file>: Specify custom services file\n"
         "  --versiondb <file>: Specify custom service probes file\n"
         "  --send-eth/--send-ip: Send using raw ethernet frames or IP packets\n"
         "  --disable-arp-ping: No ARP or ND Ping\n"
         "  --route-dst <IP_Address>: only show next hop used to reach destination IP\n"
