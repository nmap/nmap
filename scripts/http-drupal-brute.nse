...
Driver = {
	new = function(self, host, port, options)
		...
		setmetatable(o, self)
		self.__index = self
		o.host = stdnse.get_script_args("http-drupal-brute.hostname") or host
		o.port = port
		o.uri = stdnse.get_script_args("http-drupal-brute.uri") or DEFAULT_DRUPAL_URI
...
action = function(host, port)
	...
	local uservar = stdnse.get_script_args("http-drupal-brute.uservar") or DEFAULT_DRUPAL_USERVAR
	local passvar = stdnse.get_script_args("http-drupal-brute.passvar") or DEFAULT_DRUPAL_PASSVAR
	local thread_num = tonumber(stdnse.get_script_args("http-drupal-brute.threads")) or DEFAULT_THREAD_NUM
